...
import { getHtmlFromGoogle } from './getHtmlFromGoogle'
import { getSelectionAsText } from './getSelectionAsText'
import { uploadLink } from './uploadLink'

export async function makeRealGoogle(editor: Editor, apiKey: string) {
	...
	try {
		const json = await getHtmlFromGoogle({
			image: dataUrl,
			apiKey,
